...
img_dir = '/vast/eo41/SAY_1fps'  # replace this with desired data directory (we will use random images from this directory to condition on)

x = generate_images_from_half(gpt_model, vq_model, img_dir, n_imgs=n_imgs, n_samples_per_img=n_samples_per_img)
